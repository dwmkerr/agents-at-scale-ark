# Ark AI Development Protocol

This guide describes how to complete tasks in Ark. We follow a simple approach where each step is broken down - understanding intent, design, verification, iteration, development and testing and then final review. Many team members may provide input at each step.
...
| Agent | Role |
|-------|------|
| `ark-architect` | Design architecture following existing patterns |
| `ark-prototyper` | Build minimal working prototypes with checkpoints |
| `ark-technical-lead` | Finalize code quality, tests, documentation |
