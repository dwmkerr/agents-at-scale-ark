...
The `ark` metadata field identifies which agent is currently contributing, as well as other parameters for the query:
...
Clients aware of this field can display rich multi-agent interactions and tool calls.
